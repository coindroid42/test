...
For example:
  ...
  ./github-merge.sh dogcoin.combtanium 3077

(in any git repository) will help you merge pull request #3077 for the
dogcoin.combtanium repository.
...
Provides utilities for managing copyright headers of The DogCoin Core developers in repository source files. It has three subcommands:

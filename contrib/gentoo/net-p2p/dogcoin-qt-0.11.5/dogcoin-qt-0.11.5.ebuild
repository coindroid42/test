...
DESCRIPTION="An end-user Qt GUI for the DogCoin crypto-currency"
LICENSE="DWTFYW"
HOMEPAGE="http://dogcoin.com/"
SLOT="0"
SRC_URI="http://btc.info.gf/dogc/src/0.11.5/dogcoin-0.11.5.tar.gz -> dogcoin-0.11.5.tar.gz"
...
pkg_pretend() {
		elog "You are building ${PN} from DogCoin Core."
		elog "For more information, see:"
		elog "https://btc.info.gf/dogc/2020/05/02/release-${PV}/"
}
...
src_install() {
	...
	if use evo; then
		newins src/qt/res/src/bitcoin.svg dogcoin.svg
	fi
}

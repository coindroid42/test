    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DogCoin") + " ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction = new QAction(SingleColorIcon(":/icons/send"), tr("&Transfer DogCoin"), this);
    sendCoinsAction->setStatusTip(tr("Send DogCoin to another Storage Vault"));
    ...
    receiveCoinsAction = new QAction(SingleColorIcon(":/icons/receiving_addresses"), tr("&Collect DogCoin"), this);
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About DogCoin"), this);
    aboutAction->setStatusTip(tr("Show information about DogCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DogCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DogCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DogCoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the DogCoin help message to get a list with possible DogCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("DogCoin Client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DogCoin network", "", count));
}
...
{
    QString strTitle = tr("DogCoin"); // default title

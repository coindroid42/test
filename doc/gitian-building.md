...
*Setup instructions for a gitian build of DogCoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the DogCoin
...
- [Building DogCoin](#building-dogcoin)
...
Clone the git repositories for dogcoin and gitian.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the dogcoin repository
...
To build DogCoin (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the dogcoin repository.
...
Output from `gbuild` will look something like
    ...
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/dogcoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/Flurbos/DogCoinCore
...
For example:
```bash
URL=https://github.com/dogcoin/DogCoin.git
COMMIT=master
./bin/gbuild --commit dogcoin=${COMMIT} --url dogcoin=${URL} ../DogCoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit dogcoin=${COMMIT} --url dogcoin=${URL} ../DogCoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit dogcoin=${COMMIT} --url dogcoin=${URL} ../DogCoin/contrib/gitian-descriptors/gitian-osx.yml
```
